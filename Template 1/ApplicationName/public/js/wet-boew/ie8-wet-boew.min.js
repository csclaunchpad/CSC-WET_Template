...
window.Modernizr = function(a, b, c) {
    ...
    function j() {
        ...
        n.inputtypes = function(a) {
            for (var d, e, f, g = 0, h = a.length; h > g; g++)
                ...
                /^range$/.test(e) && t.style.WebkitAppearance !== c ? (p.appendChild(t),
                f = b.defaultView,
    ...
    n.testAllProps = i,
    n.testStyles = F,
    p.className = p.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (o ? " js " + D.join(" ") : ""),
    n
}(this, this.document),
function(a, b, c) {
    function d(a) {
...
Modernizr.addTest("details", function() {
    var a, b, c, d = document, e = d.createElement("details");
    return "open"in e ? (b = d.body || function() {
        var b = d.documentElement;
        return a = !0,
        b.insertBefore(d.createElement("body"), b.firstElementChild || b.firstChild)
    }(),
...
Modernizr.addTest("mathml", function() {
    ...
    if (document.createElementNS) {
        ...
        d.appendChild(document.createElementNS(b, "mi")).appendChild(document.createTextNode("xx")),
        d.appendChild(document.createElementNS(b, "mi")).appendChild(document.createTextNode("yy")),
...
document.createElement("canvas").getContext || !function() {
    ...
    function e(a) {
        if (d(a, "g_vml_", "urn:schemas-microsoft-com:vml"),
    ...
    function k(a) {
        ...
        return (4 != d.length || "a" != a.charAt(3)) && (d[3] = 1),
        d
    }
    function l(a) {
    ...
    function r(a, b) {
        ...
        var e = parseFloat(b.currentStyle.fontSize)
          , f = parseFloat(a.size);
        return "number" == typeof a.size ? c.size = a.size : -1 != a.size.indexOf("px") ? c.size = f : -1 != a.size.indexOf("em") ? c.size = e * f : -1 != a.size.indexOf("%") ? c.size = e / 100 * f : -1 != a.size.indexOf("pt") ? c.size = f / .75 : c.size = e,
        c.size *= .981,
        c
    }
    function s(a) {
    ...
    function w(a, b) {
        ...
        1 > f && (e *= f),
        b.push("<g_vml_:stroke", ' opacity="', e, '"', ' joinstyle="', a.lineJoin, '"', ' miterlimit="', a.miterLimit, '"', ' endcap="', t(a.lineCap), '"', ' weight="', f, 'px"', ' color="', d, '" />')
    }
    function x(a, b, c, d) {
        var e = a.fillStyle
          , f = a.arcScaleX_
    ...
    var P = {
        ...
        "init_": function(a) {
            for (var b = a.getElementsByTagName("canvas"), c = 0; c < b.length; c++)
        ...
        "initElement": function(b) {
            if (!b.getContext) {
                ...
                var c = b.attributes;
                c.width && c.width.specified ? b.style.width = c.width.nodeValue + "px" : b.width = b.clientWidth,
                c.height && c.height.specified ? b.style.height = c.height.nodeValue + "px" : b.height = b.clientHeight
            }
            return b
        }
    };
    ...
    Y.drawImage = function(a, b) {
        var c, d, e, f, g, h, i, j, k = a.runtimeStyle.width, l = a.runtimeStyle.height;
        a.runtimeStyle.width = "auto",
        a.runtimeStyle.height = "auto";
        var m = a.width
          , n = a.height;
        if (a.runtimeStyle.width = k,
        ...
        var o = y(this, c, d)
          ...
          , q = 10
          , r = 10;
        if (p.push(" <g_vml_:group", ' coordsize="', M * q, ",", M * r, '"', ' coordorigin="0,0"', ' style="width:', q, "px;height:", r, "px;position:absolute;"),
        1 != this.m_[0][0] || this.m_[0][1] || 1 != this.m_[1][1] || this.m_[1][0]) {
            ...
            p.push("padding:0 ", H(t.x / M), "px ", H(t.y / M), "px 0;filter:progid:DXImageTransform.Microsoft.Matrix(", s.join(""), ", sizingmethod='clip');")
        } else
            p.push("top:", H(o.y / M), "px;left:", H(o.x / M), "px;");
        p.push(' ">', '<g_vml_:image src="', a.src, '"', ' style="width:', M * e, "px;", " height:", M * f, 'px"', ' cropleft="', g / m, '"', ' croptop="', h / n, '"', ' cropright="', (m - g - i) / m, '"', ' cropbottom="', (n - h - j) / n, '"', " />", "</g_vml_:group>"),
    ...
    ,
    Y.restore = function() {
        this.aStack_.length && (j(this.aStack_.pop(), this),
    ...
    Y.drawText_ = function(a, b, d, e, f) {
        ...
        l.push('<g_vml_:line from="', -i, ' 0" to="', j, ' 0.05" ', ' coordsize="100 100" coordorigin="0 0"', ' filled="', !f, '" stroked="', !!f, '" style="position:absolute;width:1px;height:1px;">'),
        f ? w(this, l) : x(this, l, {
            "x": -i,
            "y": 0
        }, {
        ...
        var u = g[0][0].toFixed(3) + "," + g[1][0].toFixed(3) + "," + g[0][1].toFixed(3) + "," + g[1][1].toFixed(3) + ",0,0"
          , v = H(t.x / M) + "," + H(t.y / M);
        l.push('<g_vml_:skew on="t" matrix="', u, '" ', ' offset="', v, '" origin="', i, ' 0" />', '<g_vml_:path textpathok="true" />', '<g_vml_:textpath on="true" string="', c(a), '" style="v-text-align:', p, ";font:", c(n), '" /></g_vml_:line>'),
...
function(a, b) {
    ...
    function o(a) {
        ...
        return !B || a.printShived ? a : ("undefined" == typeof h[A] && h.add(A),
...
function(a) {
    ...
    function d(a) {
        ...
        if (c(a))
            return a;
        if (d = a.valueOf,
        "function" == typeof d && (b = d.call(a),
        c(b)))
            return b;
        if (e = a.toString,
        "function" == typeof e && (b = e.call(a),
        c(b)))
            return b;
        throw new TypeError
    }
    8 !== parseInt("08") && (parseInt = function(a) {
        var b = /^0[xX]/;
        return function(c, d) {
    ...
    Function.prototype.bind || (Function.prototype.bind = function(b) {
        ...
        }, f = Math.max(0, c.length - d.length), g = [], h = 0; f > h; h++)
            g.push("$" + h);
        var i = Function("binder", "return function(" + g.join(",") + "){return binder.apply(this,arguments)}")(e);
        return c.prototype && (a.prototype = c.prototype,
        i.prototype = new a,
        a.prototype = null),
        i
    }
    ...
    if ((i = o(l, "__defineGetter__")) && (e = j.bind(l.__defineGetter__),
    ...
    2 != [1, 2].splice(0).length) {
        ...
        !function() {
            ...
            var b, c = [];
            return c.splice.bind(c, 0, 0).apply(null, a(20)),
    ...
    Array.prototype.filter || (Array.prototype.filter = function(a) {
        var b, c = I(this), d = t && "[object String]" == n(this) ? this.split("") : c, e = d.length >>> 0, f = [], g = arguments[1];
        if ("[object Function]" != n(a))
            throw new TypeError(a + " is not a function");
        for (var h = 0; e > h; h++)
            h in d && (b = d[h],
    ...
    Array.prototype.reduceRight || (Array.prototype.reduceRight = function(a) {
        ...
        if (0 > f)
            return e;
        do
            f in this && (e = a.call(void 0, e, c[f], f, b));
        while (f--);return e
    }
    ),
    Array.prototype.indexOf && -1 == [0, 1].indexOf(1, 2) || (Array.prototype.indexOf = function(a) {
        ...
        if (!d)
            return -1;
        var e = 0;
        for (arguments.length > 1 && (e = b(arguments[1])),
    ...
    Array.prototype.lastIndexOf && -1 == [0, 1].lastIndexOf(0, -3) || (Array.prototype.lastIndexOf = function(a) {
        ...
        if (!d)
            return -1;
        var e = d - 1;
        for (arguments.length > 1 && (e = Math.min(e, b(arguments[1]))),
    ...
    var B = !1;
    try {
        B = Date.prototype.toJSON && null === new Date(NaN).toJSON() && -1 !== new Date(z).toJSON().indexOf(A) && Date.prototype.toJSON.call({
    ...
    Number.prototype.toFixed && "0.000" === 8e-5.toFixed(3) && "0" !== .9.toFixed(0) && "1.25" === 1.255.toFixed(2) && "1000000000000000128" === 0xde0b6b3a7640080.toFixed(0) || !function() {
        ...
        Number.prototype.toFixed = function(f) {
            ...
            return g > 0 ? (n = j.length,
            j = g >= n ? i + "0.0000000000000000000".slice(0, g - n + 2) + j : i + j.slice(0, n - g) + "." + j.slice(n - g)) : j = i + j,
            j
        }
    }();
    ...
    if (2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || "".split(/.?/).length || ".".split(/()()/).length > 1 ? !function() {
        ...
        String.prototype.split = function(b, c) {
            ...
            c = void 0 === c ? -1 >>> 0 : c >>> 0; (f = b.exec(d)) && (g = f.index + f[0].length,
            ...
            f.length > 1 && f.index < d.length && Array.prototype.push.apply(i, f.slice(1)),
            h = f[0].length,
            k = g,
            i.length >= c))); )
...
function(a, b, c, d) {
    ...
    var e = function(a) {
        ...
        return b.href = a,
        {
            ...
            "search": b.search,
            "params": function() {
                var a, c, d, e = {}, f = encodeURI(decodeURI(b.search.replace(/^\?/, ""))).replace(/'/g, "%27").split("&"), g = f.length;
                for (d = 0; d !== g; d += 1)
                    null !== (a = f[d]) && (c = a.split("="),
                    e[c[0]] = c[1]);
                return e
            }()
        }
      ...
      , i = function(b) {
        var c = {};
        return c.home = b.prop("src").split("?")[0].split("/").slice(0, -1).join("/"),
        ...
        b[0].hasAttribute("data-wb-core") && a.extend(c, {
      ...
      , j = function() {
        for (var a, b = 3, d = c.createElement("div"), e = d.getElementsByTagName("i"); d.innerHTML = "<!--[if gt IE " + (b += 1) + "]><i></i><![endif]-->",
        e[0]; )
            ;
        return b > 4 ? b : a
    }()
      ...
      , m = {
        ...
        "init": function(a, b, e, f) {
            var g = a.target
              ...
              , j = b + "-inited"
              , k = i === c;
            return !h || k || a.currentTarget === i && -1 === i.className.indexOf(j) ? (this.initQueue += 1,
            this.remove(e),
            k || (i.className += " " + j,
            f || i.id || (i.id = m.getId())),
            i) : d
        ...
        "ready": function(a, b, c) {
            a ? (a.find(m.allSelectors).addClass("wb-init").filter(":not(#" + a.attr("id") + " .wb-init .wb-init)").trigger("timerpoke.wb"),
            a.trigger("wb-ready." + b, c),
            this.initQueue -= 1) : this.doc.trigger("wb-ready." + b, c),
            !this.isReady && this.isStarted && this.initQueue < 1 && (this.isReady = !0,
        ...
        "sessionGUID": function() {
            ...
            return a || (a = m.guid(),
            sessionStorage.setItem("wb-session-GUID", a)),
            a
        },
        "add": function(a) {
            var b, c = !1, d = m.selectors.length;
            if (m.isDisabled && "#wb-tphp" !== a)
                return 0;
            for (b = 0; b !== d; b += 1)
                if (m.selectors[b] === a) {
                    c = !0;
        ...
        "timerpoke": function(b) {
            var c, d, e, f, g = m.selectors.slice(0), h = g.length;
            if (b) {
                for (e = a(),
                f = 0; f !== h; f += 1)
                    c = g[f],
    ...
    yepnope.addPrefix("site", function(a) {
        return a.url = i.js + "/" + a.url,
        a
    }),
    yepnope.addPrefix("plyfll", function(a) {
        var b, c = a.url;
        return l && -1 === c.indexOf("svg") ? a.bypass = !0 : i.mode || (c = c.replace(".min", "")),
        -1 !== c.indexOf(".css") ? (a.forceCSS = !0,
        b = i.css) : b = i.js,
        a.url = b + "/polyfills/" + c,
        a
    }),
    yepnope.addPrefix("i18n", function(a) {
        return a.url = i.js + "/" + a.url + h + i.mode + ".js",
        a
    }),
    yepnope.addPrefix("mthjx", function(a) {
        return a.url = i.js + "/MathJax/" + a.url,
        a
    }),
    ...
    Modernizr.load([{
        ...
        "complete": function() {
            ...
            Modernizr.mathml || (f.one("timerpoke.wb wb-init." + a, d, function() {
                m.init(c, a, d),
                Modernizr.load([{
